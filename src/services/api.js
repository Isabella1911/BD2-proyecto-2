...
export const crearUsuario = (body) =>
  request("/usuarios/", { method: "POST", body: JSON.stringify(body) });

export const crearUsuarioConLabel = (body) =>
  request("/usuarios/con-rol-label", { method: "POST", body: JSON.stringify(body) });

export const actualizarUsuario = (id, body) =>
  request(`/usuarios/${id}`, { method: "PATCH", body: JSON.stringify(body) });

export const eliminarUsuario = (id) =>
  request(`/usuarios/${id}`, { method: "DELETE" });

export const eliminarUsuariosBulk = (ids) =>
  request("/usuarios/bulk/eliminar", { method: "DELETE", body: JSON.stringify(ids) });
...
export const crearSupermercado = (body) =>
  request("/supermercados/", { method: "POST", body: JSON.stringify(body) });

export const actualizarSupermercado = (id, body) =>
  request(`/supermercados/${id}`, { method: "PATCH", body: JSON.stringify(body) });

export const eliminarSupermercado = (id) =>
  request(`/supermercados/${id}`, { method: "DELETE" });

export const eliminarSupermercadosBulk = (ids) =>
  request("/supermercados/bulk/eliminar", { method: "DELETE", body: JSON.stringify(ids) });
...
export const actualizarProducto = (id, body) =>
  request(`/productos/${id}`, { method: "PATCH", body: JSON.stringify(body) });

export const eliminarProducto = (id) =>
  request(`/productos/${id}`, { method: "DELETE" });

export const eliminarProductosBulk = (ids) =>
  request("/productos/bulk/eliminar", { method: "DELETE", body: JSON.stringify(ids) });
...
export const crearAlmacen = (body) =>
  request("/almacenes/", { method: "POST", body: JSON.stringify(body) });

export const actualizarAlmacen = (id, body) =>
  request(`/almacenes/${id}`, { method: "PATCH", body: JSON.stringify(body) });

export const eliminarAlmacen = (id) =>
  request(`/almacenes/${id}`, { method: "DELETE" });

export const eliminarAlmacenesBulk = (ids) =>
  request("/almacenes/bulk/eliminar", { method: "DELETE", body: JSON.stringify(ids) });
...
export const actualizarOrden = (id, body) =>
  request(`/ordenes/${id}`, { method: "PATCH", body: JSON.stringify(body) });

export const eliminarOrden = (id) =>
  request(`/ordenes/${id}`, { method: "DELETE" });

export const eliminarOrdenesBulk = (ids) =>
  request("/ordenes/bulk/eliminar", { method: "DELETE", body: JSON.stringify(ids) });
...
export const getAgregadosTransportistas = () => request("/transportistas/agregados");

export const crearTransportista = (body) =>
  request("/transportistas/", { method: "POST", body: JSON.stringify(body) });

export const actualizarTransportista = (id, body) =>
  request(`/transportistas/${id}`, { method: "PATCH", body: JSON.stringify(body) });

export const eliminarTransportista = (id) =>
  request(`/transportistas/${id}`, { method: "DELETE" });

export const eliminarTransportistasBulk = (ids) =>
  request("/transportistas/bulk/eliminar", { method: "DELETE", body: JSON.stringify(ids) });
...
export const crearAsignadoA = (body) =>
  request("/relaciones/asignado-a", { method: "POST", body: JSON.stringify(body) });
...
export const eliminarAsignadoA = (usuario_id, supermercado_id) =>
  request(`/relaciones/asignado-a?usuario_id=${usuario_id}&supermercado_id=${supermercado_id}`, {
    method: "DELETE",
  });
...
export const crearSupervisa = (body) =>
  request("/relaciones/supervisa", { method: "POST", body: JSON.stringify(body) });
...
export const eliminarSupervisa = (usuario_id, supermercado_id) =>
  request(`/relaciones/supervisa?usuario_id=${usuario_id}&supermercado_id=${supermercado_id}`, {
    method: "DELETE",
  });
...
export const crearTieneInventario = (body) =>
  request("/relaciones/tiene-inventario", { method: "POST", body: JSON.stringify(body) });
...
export const eliminarTieneInventario = (supermercado_id, producto_id) =>
  request(`/relaciones/tiene-inventario?supermercado_id=${supermercado_id}&producto_id=${producto_id}`, {
    method: "DELETE",
  });
...
export const crearAlmacenadoEn = (body) =>
  request("/relaciones/almacenado-en", { method: "POST", body: JSON.stringify(body) });
...
export const eliminarAlmacenadoEn = (producto_id, almacen_id) =>
  request(`/relaciones/almacenado-en?producto_id=${producto_id}&almacen_id=${almacen_id}`, {
    method: "DELETE",
  });
...
export const uploadCSV = (file) => {
  ...
  return fetch(`${BASE}/csv/upload`, { method: "POST", body: formData })
    .then((res) => {
